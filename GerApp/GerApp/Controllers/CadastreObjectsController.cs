...
namespace GerApp.Controllers
{
    public class CadastreObjectsController : Controller
    {
        ...
        {
            var cadastreObjects = db.CadastreObjects.Include(c => c.Request);
            return View(cadastreObjects.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "CadastreObjectsID,Price,TypeCadastre,RegistrationDate,Comment,RequestID")] CadastreObjects cadastreObjects)
        {
            ...
            ViewBag.RequestID = new SelectList(db.Requests, "RequestID", "RequestID", cadastreObjects.RequestID);
            return View(cadastreObjects);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CadastreObjectsID,Price,TypeCadastre,RegistrationDate,Comment,RequestID")] CadastreObjects cadastreObjects)
        {
            if (ModelState.IsValid)
            {
